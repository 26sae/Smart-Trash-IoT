        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              Card(
                child: Column(children: [
                  const _InfoRow(k: 'Microcontroller', v: 'ESP32'),
                  const _InfoRow(k: 'Sensors', v: 'HC-SR04 + Moisture Sensor'),
                  const _InfoRow(k: 'BIO Bin ID', v: 'BIN-001 (Biodegradable)'),
                  const _InfoRow(
                      k: 'NON-BIO Bin ID', v: 'BIN-002 (Non-Biodegradable)'),
                  const _InfoRow(k: 'Location', v: 'TIP QC Canteen'),
                  _InfoRow(
                      k: 'BIO Fill Level',
                      v: '${p.fillLevel1.toInt()}%',
                      vc: statusColor(p.fillLevel1)),
                  _InfoRow(
                      k: 'NON-BIO Fill Level',
                      v: '${p.fillLevel2.toInt()}%',
                      vc: statusColor(p.fillLevel2),
                      last: true),
                ]),
              ),
                ...
                child: Column(children: [
                  ...
                  _SettingsTile(
                    ...
                    onTap: () => _showInfo(
                        context,
                        'How It Works',
                        'The HC-SR04 ultrasonic sensor measures the distance from sensor to trash. '
                            'The Moisture Sensor detects wet waste inside the bin. '
                            'The ESP32 processes both readings and uploads fill level and sensor data '
                            'to Firebase Realtime Database every 5 minutes via Wi-Fi.'),
                  ),
                  _SettingsTile(
                    title: 'About',
...
class _InfoRow extends StatelessWidget {
  ...
  final bool last;
  const _InfoRow(
      {required this.k, required this.v, this.vc, this.last = false});
